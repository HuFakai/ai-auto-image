...
class AssetBasedPipeline(LinearVideoPipeline):
    ...
    async def __call__(
        ...
        **kwargs
        ...
        Args:
            ...
            source: Asset analysis source (only "api" is supported)
    ...
    async def initialize_storyboard(self, context: PipelineContext) -> PipelineContext:
        ...
        native_subtitle = resolve_native_subtitle_effect(
            context.params.get("subtitle_effect")
        )
        ...
        context.config = StoryboardConfig(
            ...
            voice_volume=float(context.params.get("voice_volume", 1.0)),
    ...
    async def _persist_task_data(self, ctx: PipelineContext):
        ...
        try:
            ...
            input_params = {
                ...
                "voice_volume": ctx.request.get("voice_volume", 1.0),
            }
