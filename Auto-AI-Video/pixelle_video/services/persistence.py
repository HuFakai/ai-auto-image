...
class PersistenceService:
    ...
    async def save_storyboard(
        ...
        try:
            ...
            temporary_path = storyboard_path.with_name(
                f".{storyboard_path.name}.{uuid.uuid4().hex}.tmp"
            )
            try:
                with open(temporary_path, "w", encoding="utf-8") as f:
                    ...
                    f.flush()
                    os.fsync(f.fileno())
                os.replace(temporary_path, storyboard_path)
            finally:
    ...
    def _dict_to_storyboard(self, data: Dict[str, Any]) -> Storyboard:
        ...
        return Storyboard(
            ...
            cover_duration=float(data.get("cover_duration") or 0),
    ...
    def _config_to_dict(self, config: StoryboardConfig) -> Dict[str, Any]:
        ...
        return {
            ...
            "image_motion": config.image_motion,
            "transition": config.transition,
            "transition_duration": config.transition_duration,
            "subtitle_effect": config.subtitle_effect,
            "subtitle_effect_applied": config.subtitle_effect_applied,
            "subtitle_effect_fallback_reason": config.subtitle_effect_fallback_reason,
            ...
            "template_snapshot_path": config.template_snapshot_path,
            "template_params": config.template_params,
            "hyperframes_project_path": config.hyperframes_project_path,
            "hyperframes_manifest_path": config.hyperframes_manifest_path,
            "hyperframes_check_report_path": config.hyperframes_check_report_path,
            "hyperframes_render_id": config.hyperframes_render_id,
            "hyperframes_template_id": config.hyperframes_template_id,
            "hyperframes_template_version": config.hyperframes_template_version,
            "hyperframes_template_fingerprint": config.hyperframes_template_fingerprint,
            "hyperframes_template_variables": config.hyperframes_template_variables,
            "whiteboard": config.whiteboard,
            "render_fallback_reason": config.render_fallback_reason,
        }
    ...
    def _dict_to_config(self, data: Dict[str, Any]) -> StoryboardConfig:
        ...
        return StoryboardConfig(
            ...
            render_engine=data.get("render_engine", "native_image_html"),
            renderer_version=data.get("renderer_version", "native-image-html-v1"),
            image_motion=data.get("image_motion", "none"),
            transition=data.get("transition", "none"),
            transition_duration=data.get("transition_duration", 0.35),
            subtitle_effect=data.get("subtitle_effect", "static"),
            subtitle_effect_applied=data.get(
                "subtitle_effect_applied", data.get("subtitle_effect", "static")
            ),
            subtitle_effect_fallback_reason=data.get("subtitle_effect_fallback_reason"),
            ...
            template_snapshot_path=data.get("template_snapshot_path"),
            template_params=data.get("template_params"),
            hyperframes_project_path=data.get("hyperframes_project_path"),
            hyperframes_manifest_path=data.get("hyperframes_manifest_path"),
            hyperframes_check_report_path=data.get("hyperframes_check_report_path"),
            hyperframes_render_id=data.get("hyperframes_render_id"),
            hyperframes_template_id=data.get("hyperframes_template_id"),
            hyperframes_template_version=data.get("hyperframes_template_version"),
            hyperframes_template_fingerprint=data.get("hyperframes_template_fingerprint"),
            hyperframes_template_variables=data.get("hyperframes_template_variables"),
            whiteboard=data.get("whiteboard"),
            render_fallback_reason=data.get("render_fallback_reason"),
        )
    ...
    def _frame_to_dict(self, frame: StoryboardFrame) -> Dict[str, Any]:
        ...
        return {
            ...
            "image_motion": frame.image_motion,
            "transition": frame.transition,
            "transition_duration": frame.transition_duration,
            "direction_reason": frame.direction_reason,
            ...
            "focus_confidence": frame.focus_confidence,
            "focus_source": frame.focus_source,
    ...
    def _dict_to_frame(self, data: Dict[str, Any]) -> StoryboardFrame:
        ...
        return StoryboardFrame(
            ...
            subtitle_overlay_path=data.get("subtitle_overlay_path"),
            whiteboard_silent_path=data.get("whiteboard_silent_path"),
            whiteboard_analysis_path=data.get("whiteboard_analysis_path"),
            video_segment_path=data.get("video_segment_path"),
            duration=data.get("duration", 0.0),
            image_motion=data.get("image_motion"),
            transition=data.get("transition"),
            transition_duration=data.get("transition_duration"),
            direction_reason=data.get("direction_reason"),
            subtitle_effect=data.get("subtitle_effect"),
            subtitle_effect_applied=data.get("subtitle_effect_applied"),
            subtitle_effect_fallback_reason=data.get(
                "subtitle_effect_fallback_reason"
            ),
            subtitle_keywords=list(data.get("subtitle_keywords") or []),
            subtitle_start_offset=float(data.get("subtitle_start_offset") or 0),
            subtitle_end_offset=float(data.get("subtitle_end_offset") or 0),
            focus_x=data.get("focus_x"),
            focus_y=data.get("focus_y"),
            focus_confidence=data.get("focus_confidence"),
            focus_source=data.get("focus_source"),
            created_at=datetime.fromisoformat(data["created_at"]) if data.get("created_at") else None,
        )
